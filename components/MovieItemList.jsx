...
const MovieItemList = ({ movie }) => {
  return (
    <div className="flex  flex-row group ml-6 h-[7rem]  z-50 gap-1 max-w-[210px] ">
      <div className="   h-fit ">
        <img
          ...
          group-hover:hidden
          min-h-fit
         flex transition delay-75 cursor-pointer
          object-cover  max-w-[210px]"
          alt="image"
        />
      </div>
      <div
  ...
  group-hover:opacity-100
   ...
   group-hover:-translate-x-16  w-[300px] 
    -top-[150px] scale-75 
    group-hover:scale-100 
    -left-8 pb-3 m-4"
      >
        <div className=" rounded-t bg-zinc-900">
          <img
            src={movie?.thumbnailUrl}
        ...
        <div className=" bg-zinc-900">
          ...
          <div className="text-white pl-4 pt-4">{movie.duration}</div>
          <div className="text-white pl-4 pt-2 text-xl">{movie.genre}</div>
        </div>
      </div>
    </div>
  );
